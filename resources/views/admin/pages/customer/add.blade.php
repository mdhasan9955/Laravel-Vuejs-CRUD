            ...
            <div class="box box-primary"> 
                <div class="box-body">
                    <div class="col-lg-6 custom-error-msg">
                        {!! Form::open(['route' => 'admin.customer.create','files' => true]) !!}   
                        ...
                        <div class="form-group">
                            ...
                            <b><span>*</span></b> 
                            {{ Form::text('mobile_no','',['class' => 'form-control','required'=>'required' ]) }}
                        ...
                        <div class="form-group">
                            ...
                            <b><span>*</span></b> 
                            {{ Form::text('product_used','',['class' => 'form-control','required'=>'required']) }}
                        ...
                        <div class="form-group">
                            ...
                            <b><span>*</span></b> 
                            {{ Form::text('expiry_date','',['class' => 'form-control datepicker ','required'=>'required']) }} 
