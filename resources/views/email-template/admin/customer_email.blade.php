                ...
                <td colspan="3" style="padding:35px;">
                    <table>
                        <tbody>
                            ...
                            <tr>
                                <td style="padding-right: 35px;">Company name</td>
                                <td>{{$company_name}}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="padding-right: 35px;">Mobile number</td>
                                <td>{{$mobile_no}} </td>
                            </tr>
                            <tr>
                                <td style="padding-right: 35px;">URL</td>
                                <td>{{$url}} </td>
                            </tr>
                            <tr>
                                <td style="padding-right: 35px;">Product used</td>
                                <td>{{$product_used}} </td>
                            </tr>
                            <tr>
                                <td style="padding-right: 35px;">Designation</td>
                                <td>{{$designation}} </td>
                            </tr>
                            <tr>
                                <td style="padding-right: 35px;">Contact number</td>
                                <td>{{$contact_no}} </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="2"><a href="{{ route('welcome') }}"><h3>Enjoy your account - login </h3></a></td> 
                            </tr> 
                            <tr>
                            ...
                            <tr>
                                <td style="padding-right: 35px;"><a href="http://rightclick.com.bd/">Rightclick.com.bd</a></td>
                                <td></td>
                            </tr> 
                        </tbody> 
                    </table>
