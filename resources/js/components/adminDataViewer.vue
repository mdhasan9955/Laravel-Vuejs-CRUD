      ...
      <table class="dv-table table table-striped table-bordered table-hover">
        ...
        <tbody>
          <tr v-for="row in model.data">
            ...
            <td>
            <a v-if="authData.type !='User'" :href="'user/edit/'+ row.id" title="Edit" class="btn btn-warning btn-xs"><i class="fa fa-edit"></i></a>
            <a :href="'user/delete/'+ row.id" title="Delete" onclick="return confirm('Are you sure you want to Delete?')" data-toggle="modal" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></a></td>
          </tr>
        </tbody>
      </table>
    </div>
